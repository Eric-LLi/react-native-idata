...
public class MConstant {
    public static final byte SLR1100 = 10;// SLR1200 module
    public static final byte SLR1200 = 11;// SLR1200 module
    public static final byte SLR5100 = 14;// SLR5100 module
